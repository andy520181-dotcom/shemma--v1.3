            ...
            <div className="flex flex-col items-center w-full pt-2 px-6 pb-6 h-full justify-between">
                        ...
                        <div className="relative min-w-[50%] flex justify-center mt-1">
                            {isEditingType ? (
                                <input
                                    ...
                                    className={`bg-transparent text-center text-[#333333] font-medium outline-none border-none p-0 w-full caret-[#333333] ${getFontSizeClass(tempType)}`}
                                />
                            ) : (
                                <div
                    ...
                    <div className="w-full px-2 text-center mt-0 flex justify-center relative shrink-0">
                        {isEditingQuote ? (
                            <textarea
                                ...
                                className="w-full bg-transparent text-gray-500 text-lg font-light outline-none border-none p-0 text-center resize-none overflow-hidden caret-gray-500"
                                rows={2}
                            />
                        ) : (
                            <div
                ...
                {!readOnly && (
                    <div className="flex flex-col items-center opacity-10 gap-1 shrink-0 mt-2">
                        ...
                        <p className="text-black text-[12px] tracking-wide font-light">长按可自定义编辑内容</p>
                    </div>
                )}
            </div>
        </div>
